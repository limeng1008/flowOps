...
export class AddEntitlementEntity1777300000001 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE IF NOT EXISTS entitlement_usage (
                ...
                metadata text,
                "createdDate" timestamp NOT NULL DEFAULT now(),
                CONSTRAINT "PK_entitlement_usage" PRIMARY KEY (id)
            );
        `)
        await queryRunner.query(
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_entitlement_usage_entitlementId" ON entitlement_usage ("entitlementId");`)
