    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE IF NOT EXISTS "payment_notification_log" (
                ...
                CONSTRAINT "PK_payment_notification_log" PRIMARY KEY ("id")
            );
        `)
        ...
        await queryRunner.query(`CREATE INDEX "IDX_payment_notification_log_createdDate" ON "payment_notification_log" ("createdDate");`)
    }
