...
jest.mock('../../iam/entities', () => ({ Workspace: class Workspace {} }))
jest.mock('../../iam/query', () => ({ getWorkspaceSearchOptions: jest.fn().mockReturnValue({}) }))
...
jest.mock('uuid', () => ({ validate: jest.fn().mockReturnValue(true), v4: jest.fn(() => 'mock-uuid-v4') }))
