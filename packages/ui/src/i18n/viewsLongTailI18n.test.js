...
const requiredKeys = [
    ...
    'pages.executions.stateUnknown',
    'pages.executions.failureSummary',
    'pages.executions.jumpToFailedStep',
    'pages.executions.copyExecutionJson',
    'pages.executions.exportExecutionJson',
    'pages.executions.executionJsonCopied',
    'pages.executions.loadingExecution',
    'pages.executions.loadingExecutions',
    'pages.executions.loadFailed',
    'pages.executions.loadFailedDescription',
