...
const CanvasHeader = ({ chatflow, isAgentCanvas, isAgentflowV2, handleSaveFlow, handleDeleteFlow, handleLoadFlow }) => {
    ...
    const onSettingsItemClick = (setting) => {
        ...
        if (setting === 'deleteChatflow') {
            ...
            if (canvas.isDirty) {
                enqueueSnackbar({
                    message: t('canvas.pleaseSaveBeforeExport'),
                    options: {
        ...
        <>
            <Stack flexDirection='row' justifyContent='space-between' sx={{ width: '100%' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Available permission={savePermission}>
                        <ButtonBase title={t('canvas.saveTooltip', { type: title })} sx={{ borderRadius: '50%', mr: 2 }}>
                            <Avatar
                                variant='rounded'
                                sx={{
                                    ...theme.typography.commonAvatar,
            ...
            <SaveChatflowDialog
                show={flowDialogOpen}
                dialogProps={{
                    title: t('canvas.saveDialogTitle', { type: title }),
