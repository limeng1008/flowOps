...
const ForgotPasswordPage = () => {
    ...
    useEffect(() => {
        if (forgotPasswordApi.error) {
            ...
            setResponseMsg({
                type: 'error',
                msg: errMessage ?? t('auth.resetInstructionsFailed')
            })
            setLoading(false)
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    useEffect(() => {
        if (forgotPasswordApi.data) {
            setResponseMsg({
                type: 'success',
                msg: t('auth.resetInstructionsSent')
            })
            setLoading(false)
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        <>
            <MainCard>
                <Stack flexDirection='column' sx={{ width: '480px', gap: 3 }}>
                    ...
                    <Stack sx={{ gap: 1 }}>
                        <Typography variant='h1'>{t('auth.forgotPasswordTitle')}</Typography>
