    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <Typography variant='body2'>{t('common.itemsPerPage')}</Typography>
                <FormControl
                    variant='outlined'
                    size='small'
                    sx={{
            ...
            {totalItems > 0 && (
                <Typography variant='body2'>
                    {t('common.itemsRange', {
                        start: activePage * itemsPerPage - itemsPerPage + 1,
                        end: activePage * itemsPerPage > totalItems ? totalItems : activePage * itemsPerPage,
                        total: totalItems
                    })}
                </Typography>
            )}
